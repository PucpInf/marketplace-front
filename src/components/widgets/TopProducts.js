                     ...
                     {Data.slice(0, itemsToShow).map((data, index) => (
                        <Grid key={index} item xs={12} sm={6} md={6} lg={3} className="mb-30 py-0">
                           <Card className="iron-product-item p-25 iron-shadow position-relative hover-box-shadow">
                              <div>
                                 {/* <Link to={`/products/${data.type}/${data.id}`} className='d-block'>
                                    <CardMedia
                                       height="140"
                                       component="img"
                              ...
                              <CardContent className="iron-product-content pt-20 p-0 border">
                                 {/* <Link to={`/products/${data.type}/${data.id}`} className="d-block mb-sm-15 mb-10 secondary-color text-14 text-capitalize">{data.category}</Link> */}
                                 <h5 className="text-truncate mb-sm-15 mb-10"><Link to={`/products/detail/${data.id}`}>{data.title}</Link></h5>
