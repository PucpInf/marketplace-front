...
// actions
import { hideAlert, generalActions } from "@actions/action";
               ...
               <Fragment>
                  {this.getUrl(location.pathname) ?
                     ...
                     <div className="app-container">
                        ...
                        <ProductReview />
                        <Switch>
                           <Route exact path="/" component={AsyncHomePageThreeComponent} />
                           ...
                           <Route path="/products/detail/:id" component={AsyncProductDetailComponent} />
                           ...
                           <Route path="/sign-up-fb" component={AsyncSignUpFbComponent} />
...
const mapDispatchToProps = (dispatch) => {
   return {
      hideAlert,
      getCurrentRegion: (success, failure) => dispatch(generalActions.getCurrentRegion(success, failure)),
   };
}
