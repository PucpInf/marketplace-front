...
// Register with fb
const AsyncSignUpFbComponent = Loadable({
   loader: () => import('../routes/session/sign-up-fb'),
   loading: () => <ContentLoader />,
});
...
//list all provider products
const AsyncProviderProductsComponent = Loadable({
   loader: () => import('../routes/admin-panel/products/provider-products'),
   loading: () => <ContentLoader />,
});
//add product in admin panel
const AsyncProductRequestsComponent = Loadable({
   loader: () => import('../routes/admin-panel/products/product-requests'),
   loading: () => <ContentLoader />,
});
...
const AsyncContentVersionComponent = Loadable({
   loader: () => import('../routes/admin-panel/products/content-version'),
   loading: () => <ContentLoader />,
});
...
//provider content request - list
const AsyncAppRequestsComponent = Loadable({
   loader: () => import('../routes/admin-panel/products/app-requests'),
   loading: () => <ContentLoader />,
});

//provider reports
const AsyncProductReveneuStats = Loadable({
   loader: () => import('../routes/admin-panel/reports/reveneu-reports'),
   loading: () => <ContentLoader />,
});

const AsyncProductDownloadStats = Loadable({
   loader: () => import('../routes/admin-panel/reports/downloads-reports'),
   loading: () => <ContentLoader />,
});

//admin whitelist

const AsyncProviderWhitelist = Loadable({
   loader: () => import('../routes/admin-panel/providers/whitelist'),
   loading: () => <ContentLoader />,
});
